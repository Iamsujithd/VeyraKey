...
- **Last updated:** 2026-07-28T13:00:00Z — Extension 0.6.6 excludes malformed blank-username duplicates when a usable named login exists, preventing the false multi-account picker shown in manual testing.
