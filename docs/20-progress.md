...
- **Last updated:** 2026-07-27T17:28:00Z — Extension 0.6.1 removes the unlocked-session autofill bypass: every credential release now requires fresh biometric or master-password verification.
...
- **Validation:** The current whole-repository check passes with 35 test files and 183 tests. The suites cover lookalikes, IDNs, frames, ambiguity, form events, mandatory fresh manual/biometric exact-origin handoff, already-unlocked and canceled-biometric regressions, rejected-secret clearing, capture decisions, explicit confirmation, generator rejection sampling, RFC TOTP vectors, QR payloads, clipboard replacement races, encrypted item plaintext inspection, encrypted search/tamper handling, persistence migration, manifests, and production builds.
...
- **Artifact evidence:** Version 0.6.1 Chrome ZIP SHA-256 `ff26555ecbacb334620cd71408f4cf1049823469b2000db52b72f1e66834312f`; Firefox ZIP SHA-256 `7ec1e3e088dd43bbaf50ddec2f1ed689adbf5f0dd2d27e4fe67c07ed67920c0f`; source ZIP SHA-256 `4c0f9be88518222436e80f27624e5f5453453f0ba40549157f47be5dd6105cbe`; lockfile SHA-256 `eb159431d99f74d8498e15bc0b6d527ee14cfa81f261357954f0474affdf8294`.
- **Latest validation:** `CI=true pnpm check` passes with 35 test files and 183 tests, all production targets, and artifact verification. The 0.6.1 regression suite proves an already-unlocked manager still performs a fresh device ceremony, a canceled ceremony releases no credential, and the generated content script contains no legacy direct-plaintext selection protocol. The prior isolated real-Chromium lifecycle run verified extension loading, content-script readiness, dynamic username detection, replaced password-step detection, pending-save survival across service-worker termination/navigation, and extension-origin WebAuthn PRF capability; a physical Touch ID ceremony remains manual release evidence.
