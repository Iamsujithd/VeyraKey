...
- **Last updated:** 2026-07-28T12:35:00Z — Extension 0.6.4 opens protected AutoFill in Chrome's toolbar action popover instead of a separate native window and verifies multi-account selection-to-fill behavior.
